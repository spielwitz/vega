...
{
	void addRecipientsString(String recipientsString);
	String getClientUserIdForMessenger();
	ArrayList<Message> getMessagesByRecipientsString(String recipientsString);
	ArrayList<User> getUsersForMessenger();
	boolean hasUnreadMessages(String recipientsString);
