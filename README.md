...
Download the zip file from the [`release`](release) folder and extract its contents to a local folder of your choice. The following jar files are executables and can be started by double-click:
